...
__used __section(__versions) = {
	...
	{ 0xe894d462, "usb_wwan_dtr_rts" },
	{ 0x9d562464, "usb_wwan_tiocmset" },
	{ 0xbaaad3f4, "usb_wwan_tiocmget" },
	{ 0x17ff9373, "usb_wwan_chars_in_buffer" },
	{ 0x9d557304, "usb_wwan_write_room" },
	{ 0xea210b89, "usb_wwan_write" },
	{ 0x3ae125c1, "usb_wwan_close" },
	{ 0xdd48ce, "usb_wwan_open" },
	{ 0x646e1d7, "usb_wwan_resume" },
	{ 0x1952a3bb, "usb_wwan_suspend" },
